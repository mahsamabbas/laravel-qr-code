        ...
        <b-card id="cardLogin" class="scale-in-bl">
          <b-form @submit.prevent="onSubmit" id="formLogin">
            ...
            <b-row class="lineHeight">
              <div :class="{ 'form-group--error': $v.size.$error }">
                <b-form-group id="input-group-1" label-for="content">
                  <b-form-input
                    id="size"
                    class="input"
                    v-model="size"
              ...
              <div v-if="$v.size.$error">
                <span class="error" v-if="!$v.size.required"> Required </span>
            ...
            <b-row class="lineHeight">
              <div :class="{ 'form-group--error': $v.content.$error }">
                <b-form-group id="input-group-1" label-for="content">
                  <b-form-input
                    id="content"
                    class="input"
            ...
            <b-row class="lineHeight">
              <b-col md="6">
                <b-form-group id="input-group-1" label-for="color">
                  Background color
                  <color-picker
                    :color="color"
                    :sucker-hide="false"
              ...
              <b-col md="6">
                <b-form-group id="input-group-1" label-for="colorFill">
                  Fill color
                  <color-picker
                    :color="colorFill"
                    :sucker-hide="false"
...
export default {
  ...
  validations() {
    return {
      ...
      content: { required, minLength: minLength(3), maxLength: maxLength(20) },
    };
  },
};
</script>
